...
const webDevelopmentData = {
  ...
  subtitle: 'Custom websites and web applications built with modern technologies',
  description: 'We create stunning, responsive websites and powerful web applications that drive business growth. Our expert team uses cutting-edge technologies to deliver solutions that are fast, secure, and scalable.',
  features: [
    {
      icon: Code,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              <span className="bg-gradient-to-r from-blue-600 to-emerald-500 bg-clip-text text-transparent">
                {webDevelopmentData.title}
              </span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              {webDevelopmentData.subtitle}
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed max-w-4xl mx-auto">
              {webDevelopmentData.description}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {webDevelopmentData.features.map((feature, index) => (
              <Card 
                key={feature.title}
